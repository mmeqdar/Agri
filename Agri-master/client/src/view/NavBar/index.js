...
export default function PrimarySearchAppBar() {
  ...
  if (localStorage.getItem('langue')  !== 'ar'){
    ...
    const renderMenu = (
      ...
      >
        <NavLink to="/account/login" className={classes.btn} activeClassName={classes.navbarLinkActive}>
          <MenuItem onClick={handleMenuClose} >{t('nav.LOGIN')}</MenuItem>
        </NavLink>
        <NavLink to="/account/register" className={classes.btn} activeClassName={classes.navbarLinkActive}>
